...
[Français](../french/README.md) • [日本語](../japanese/README.md) • [한국어](../korean/README.md) • [中文](../chinese/README.md) • [Español](../spanish/README.md) • [Italiano](../italian/README.md) • [Nederlands](../dutch/README.md) • [Polski](../polish/README.md) • [Türkçe](../turkish/README.md) • [Українська](../ukrainian/README.md) • [Ελληνικά](../greek/README.md) • [العربية](./README.md)
...
لمسارات عمل وكلاء الذكاء الاصطناعي الأكثر تقدمًا وخطوط أنابيب المعالجة متعددة المراحل، نقوم ببناء [AgentDock Pro](../../docs/agentdock-pro.md) - منصة قوية لإنشاء وتصور وتنفيذ أنظمة وكلاء معقدة.
...
للحصول على شرح مفصل لمكونات وقدرات نظام العقد، راجع [وثائق نظام العقد](../../docs/nodes/README.md).

## 🚀 البدء

للحصول على دليل شامل، راجع [دليل البدء](../../docs/getting-started.md).
...
| :---------------------- | :------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------- |
| **إدارة الجلسات**      | إدارة حالة معزولة وعالية الأداء للمحادثات                                                 | [وثائق الجلسات](../../docs/architecture/sessions/README.md)                      |
| **إطار عمل التنسيق**   | التحكم في سلوك الوكيل وتوافر الأدوات بناءً على السياق                                      | [وثائق التنسيق](../../docs/architecture/orchestration/README.md)                 |
| **تجريد التخزين**     | نظام تخزين مرن مع موفرين قابلين للتوصيل لـ KV و Vector والتخزين الآمن                    | [وثائق التخزين](../../docs/storage/README.md)                                    |
...
يتضمن AgentDock العديد من قوالب الوكلاء المعدة مسبقًا. استكشفها في دليل `agents/` أو اقرأ [وثائق قوالب الوكلاء](../../docs/agent-templates.md) للحصول على تفاصيل التكوين.
...
| [**Code Playground**](../../docs/roadmap/code-playground.md) | إنشاء وتنفيذ تعليمات برمجية في بيئة معزولة مع قدرات تصور غنية                               | مخطط له     |
| [**وكيل الذكاء الاصطناعي العام**](../../docs/roadmap/generalist-agent.md) | وكيل يشبه Manus يمكنه استخدام المتصفح وتنفيذ المهام المعقدة                                  | مخطط له     |
...
للحصول على وثائق فنية مفصلة حول هذه المكونات، راجع [نظرة عامة على البنية](../../docs/architecture/README.md).
...
| الميزة                                                                      | الوصف                                                                                               | الفئة           |
| :-------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------- | :-------------- |
| [**طبقة تجريد التخزين**](../../docs/roadmap/storage-abstraction.md)             | نظام تخزين مرن مع موفرين قابلين للتوصيل                                                              | **قيد التقدم**  |
| [**أنظمة الذاكرة المتقدمة**](../../docs/roadmap/advanced-memory.md)              | إدارة السياق طويلة الأجل                                                                             | **قيد التقدم**  |
| [**تكامل تخزين المتجهات**](../../docs/roadmap/vector-storage.md)               | استرجاع قائم على التضمين للمستندات والذاكرة                                                          | **قيد التقدم**  |
| [**إطار تقييم وكلاء الذكاء الاصطناعي**](../../docs/roadmap/evaluation-framework.md) | إطار عمل اختبار وتقييم شامل                                                                         | **قيد التقدم**  |
| [**تكامل المنصات**](../../docs/roadmap/platform-integration.md)             | دعم Telegram و WhatsApp ومنصات المراسلة الأخرى                                                     | **مخطط له**     |
| [**تعاون متعدد الوكلاء**](../../docs/roadmap/multi-agent-collaboration.md)      | السماح للوكلاء بالعمل معًا                                                                          | **مخطط له**     |
| [**تكامل بروتوكول سياق النموذج (MCP)**](../../docs/roadmap/mcp-integration.md) | دعم اكتشاف واستخدام الأدوات الخارجية عبر MCP                                                       | **مخطط له**     |
| [**وكلاء الذكاء الاصطناعي الصوتيون**](../../docs/roadmap/voice-agents.md)          | وكلاء ذكاء اصطناعي يستخدمون واجهات صوتية وأرقام هواتف عبر AgentNode                              | **مخطط له**     |
| [**القياس عن بعد والتتبع**](../../docs/roadmap/telemetry.md)                   | تسجيل متقدم وتتبع الأداء                                                                          | **مخطط له**     |
| [**AgentDock Pro**](../../docs/agentdock-pro.md)                           | منصة سحابية كاملة للمؤسسات لتوسيع نطاق وكلاء الذكاء الاصطناعي ومسارات العمل                          | **سحابي**       |
| [**منشئ وكلاء الذكاء الاصطناعي باللغة الطبيعية**](../../docs/roadmap/nl-agent-builder.md) | منشئ مرئي + بناء وكلاء ومسارات عمل باللغة الطبيعية                                                  | **سحابي**       |
| [**سوق الوكلاء**](../../docs/roadmap/agent-marketplace.md)                 | قوالب وكلاء قابلة للتسييل                                                                          | **سحابي**       |
